...
public interface WorldValues {
	...
	public final class WorldObjectValues {
		...
		public RootObjectValues change = new RootObjectValues();  //Contains changes from the original every other value is default
		...
		public static RootObjectValues compare(RootObject obj1, RootObject obj2) {
			RootObjectValues change = new RootObjectValues();
