...
/**
 * Root object for World objects. It holds basic information like name, texture etc.
 */
public class RootObject {
    ...
    public void checkSize(World world) {
        ...
        if(values.fixtures != null) {
            for (RootValues.Fixture f : values.fixtures) { //Apply rules to hitboxes
    ...
    public final RootObject copy() {  //TODO Copy animations
